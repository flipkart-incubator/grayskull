...
class AuthenticationFilterTest {
    ...
    private final AuthenticationFilter authenticationFilter = new AuthenticationFilter(authenticationHandler, authenticationEntryPoint);
    ...
    void doFilterInternal_WhenAuthenticationSuccessful_ShouldSetSecurityContext() throws ServletException, IOException {
        ...
        when(authenticationHandler.authenticate(request)).thenReturn(authentication);
    ...
    void doFilterInternal_WhenAuthenticationReturnsNull_ShouldContinueChain() throws ServletException, IOException {
        // Arrange
        when(authenticationHandler.authenticate(request)).thenReturn(null);
    ...
    void doFilterInternal_WhenAuthenticationFails_ShouldCallEntryPoint() throws ServletException, IOException {
        ...
        when(authenticationHandler.authenticate(request)).thenThrow(authException);
