...
public interface SecretService {
    ...
    /**
     * Lists secrets for a given project with pagination. Always returns the latest version of the secret.
    ...
    /**
     * Reads the metadata of a specific secret. Always returns the latest version of the secret.
     * @param projectId The ID of the project.
    ...
    /**
     * Reads the value of a specific secret. Always returns the latest version of the secret.
     * @param projectId The ID of the project.
     * @param secretName The name of the secret.
